...
DROP TABLE IF EXISTS `solr_queue_flash`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `solr_queue_flash` (
  ...
  KEY `FK_solr_queue_flash::events` (`event_id`),
  KEY `FK_solr_queue_flash::skus` (`sku`),
...
) ENGINE=InnoDB AUTO_INCREMENT=14890030 DEFAULT CHARSET=latin1;
