...
DROP TABLE IF EXISTS `std_size_mapping`;
...
CREATE TABLE `std_size_mapping` (
  ...
  `std_size` varchar(20) NOT NULL,
  PRIMARY KEY (`member_division_cd`,`member_department_cd`,`member_class_cd`,`member_subclass_cd`,`size`)
