...
DROP TABLE IF EXISTS `bucket_1a_return_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bucket_1a_return_items` (
...
) ENGINE=InnoDB AUTO_INCREMENT=17521329 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT COMMENT='InnoDB free: 487424 kB';
